...
@Slf4j
public class PermissionModuleDubboController {

  /** 模块名 * */
  public static final String MODULE_NAME = "PermissionModule";

  /** 模块包名 * */
  public static final String MODULE_PACKAGE = "com.project.test";

  /** DTO包名 * */
  public static final String DTO_PACKAGE = "com.project.test.api.dto";

  /** api包名 * */
  public static final String API_PACKAGE = "com.project.test.api";
  ...
  public Object getInvokeApi(
      ...
      throws Exception {
    service = addPackageName(API_PACKAGE, service);
    if (dubboEnabled) {
  ...
  private String addPackageName(String apiPackage, String service) {
    if (service.indexOf(PACKAGE_SEP) < 0) {
      return apiPackage + PACKAGE_SEP + service;
    } else {
      return service;
    }
  }
  ...
  public Object metadata(
    ...
    if (className.indexOf(PACKAGE_SEP) > -1) {
      ...
      feilds = metadataService.getDtoFieldsMetadata(DTO_PACKAGE, className);
      serviceClass = getApiServiceClass(API_PACKAGE + PACKAGE_SEP + className);
    }
