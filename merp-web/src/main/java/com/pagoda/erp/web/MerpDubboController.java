...
@Slf4j
public class MerpDubboController {

  /** 模块名 * */
  public static final String MODULE_NAME = "Merp";

  /** 模块包名 * */
  public static final String MODULE_PACKAGE = "com.pagoda.erp";

  /** DTO包名 * */
  public static final String DTO_PACKAGE = "com.pagoda.erp.api.dto";

  /** api包名 * */
  public static final String API_PACKAGE = "com.pagoda.erp.api";
