...
public class UserDubboController {
  ...
  /** 模块包名 * */
  public static final String MODULE_PACKAGE = "com.pagoda.user";

  /** DTO包名 * */
  public static final String DTO_PACKAGE = "com.pagoda.user.api.dto";

  /** api包名 * */
  public static final String API_PACKAGE = "com.pagoda.user.api";
