...
public abstract class BaseMemberServiceImpl implements MemberService {
    ...
    @Override
    public Page<> findDep(@ApiParam("depName") String depName, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
            return repository.findDep(depName, pageable);
        } catch (Exception e) {
            throw new ServiceException(e);
        }
