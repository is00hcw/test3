...
public abstract class BaseMemberServiceImpl implements MemberService {
    ...
    @Override
    public Page<MemberDTO> findBy(@ApiParam("depName")String depName, @ApiParam("memberAge")Integer memberAge, @ApiParam("memberName")String memberName, @ApiParam("enumerateMultiple")String enumerateMultiple, @ApiParam("enumerate")String enumerate, @ApiParam("mDate")java.util.Date mDate, @ApiParam("mDatetime")java.sql.Timestamp mDatetime, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
            return repository.findBy(depName,memberAge,memberName,enumerateMultiple,enumerate,mDate,mDatetime, pageable);
        } catch (Exception e) {
            throw new ServiceException(e);
        }
    }
    ...
    @Override
    public Page<MemberDTO> findAllMembers(, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
            return repository.findAllMembers(, pageable);
        } catch (Exception e) {
            throw new ServiceException(e);
        }
