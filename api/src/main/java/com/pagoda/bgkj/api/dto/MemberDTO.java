...
@EntityFeature(entityName="MemberDTO", persistent=true, batchImport=true, treeStyle=true, auditable=false, traceable=false, approvalRequired=true, requestUrl="zxxx", tableMultiSelect=true)
public class MemberDTO implements Serializable {
    ...
    @ApiModelProperty(name="memberAge", value="年龄", dataType="整型", notes="5aab86517c51e0fcf5fea739")
    ...
    @ApiModelProperty(name="memberName", value="成员名称", dataType="枚举", notes="5aab86077c51e0fcf5fea4ec")
    ...
    @ApiModelProperty(name="depName", value="部门名称", dataType="枚举", notes="5aac8d1e7c51e0fcf5ff30eb")
    ...
    @FieldMeta(name="memberNum", scene="sys", nameCN="成员数", nameEN="member num", type="整型", format="#", displayLen=1, formSize="", constraint="", constraintParams="",
        persistent=true, canQuery=true, readOnly=false, required=true, visible=true, defaultValue="", tag="", sortable=true, enumerationType=false, constraintParamsExtra="", fixed="")
    @ApiModelProperty(name="memberNum", value="成员数", dataType="整型", notes="5aacc6887c51e0fcf5ff9bd9")
    ...
    @FieldMeta(name="name", scene="sys", nameCN="名称", nameEN="name", type="字符串", format="$", displayLen=1, formSize="", constraint="", constraintParams="",
        persistent=true, canQuery=true, readOnly=true, required=true, visible=true, defaultValue="", tag="", sortable=true, enumerationType=false, constraintParamsExtra="", fixed="")
    @ApiModelProperty(name="name", value="名称", dataType="字符串", notes="5aacc6187c51e0fcf5ff9b07")
    private String name;
    ...
    @ApiModelProperty(name="username", value="用户名", dataType="字符串", notes="5aacdea57c51e0fcf5ffb972")
