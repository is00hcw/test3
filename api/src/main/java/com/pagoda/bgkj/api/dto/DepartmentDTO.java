...
@EntityFeature(entityName="DepartmentDTO", persistent=true, batchImport=true, treeStyle=true, auditable=false, traceable=false, approvalRequired=true, requestUrl="xxx", tableMultiSelect=true)
public class DepartmentDTO implements Serializable {
    ...
    @ApiModelProperty(name="depType", value="部门类型", dataType="整型", notes="5aac8e177c51e0fcf5ff3123")
