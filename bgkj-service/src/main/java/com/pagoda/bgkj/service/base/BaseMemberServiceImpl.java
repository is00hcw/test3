...
public abstract class BaseMemberServiceImpl implements MemberService {
  ...
  public Page<MemberDTO> findBy(
    ...
    try {
      return repository.findBy(
          depName, memberAge, memberName, enumerateMultiple, enumerate, mDate, mDatetime, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
  ...
  @Override
  public Page<MemberDTO> findByName(
  ...
  @Override
  public Page<MemberDTO> findAllMembers(@ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
  ...
  @Override
  public Page<FindMemberInDepDTO> findMemberInDep(
      @ApiParam("memberName") String memberName, @ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
  ...
  @Override
  public Page<MemberDTO> findMemberOrderBy(@ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
      return repository.findMemberOrderBy(pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
