...
public interface MemberRepository extends MemberRepositoryCustom, PagodaJpaRepository<Member,Long>  {
     ...
     * @return
     */
    @SqlTemplate(name="findAllMembers" , sql="select * from Member where memberName=:memberName")
    Page<MemberDTO> findAllMembers(@Param("memberName") String memberName,  @Param("pageable") Pageable pageable);
     ...
     * @return
     */
    @SqlTemplate(name="findMemberInDep" , sql="SELECT	memberName AS NAME, memberAge AS age , depType AS dType FROM Member m,Department d WHERE m.depName=d.depName and memberName=:memberName")
    Page<FindMemberInDepDTO> findMemberInDep(@Param("memberName") String memberName,  @Param("pageable") Pageable pageable);
     ...
     * @return
     */
    @SqlTemplate(name="findDep" , sql="select * from Department where depName=:depName")
    Page<> findDep(@Param("depName") String depName,  @Param("pageable") Pageable pageable);
